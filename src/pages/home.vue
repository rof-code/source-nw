...
export default {
  components: {
    ...
    bannerNewwhite: () => import('@/components/gerais/bannerNewwhite.vue'),
    frete: () => import("@/components/gerais/frete.vue"),
    beneficios: () => import("@/components/gerais/beneficios.vue"),
    pratico: () => import("@/components/gerais/pratico.vue"),
    comoFunciona: () => import("@/components/gerais/comoFunciona.vue"),
