                ...
                <div class="row" style="max-width:100%;">
                    <div class="col-sm-8">
                        <div class="imgMob mob" style="width:100%;">
                            <img src="@/assets/img/3potesf.jpg" alt="">
                        </div>
                    </div>
                    <div class="col-sm-4" style="margin-top:30px;">
                        <div class="col-sm-12" style="margin-top:20px;">
                            <h1 style="font-size:60px;margin-bottom:20px;line-height:34px;">New White <br/> <span style="font-size:30px;margin-left:3px;">Compre 2 Leve 4</span></h1>
                            ...
                            <div class="precos_alt">
                                <p style="color:#6b6b6b;font-size:20px;display:inline;margin:0px 20px"><s>De: R$ 359,70</s></p>
                                <p style="font-weight:bold;color:#000;font-size:20px;display:inline;margin:0px 20px;">Por: R$ 227,70</p>
                                <img class="my-3" src="@/assets/img/img-ou.png" alt="" style="display:block;margin:0 auto;">
                                <p style="color:#000;font-size:30px;text-align:center;">12x de <strong>R$ 18,98</strong> sem juros</p>
                            </div>
...
<style lang="scss" scoped>
   ...
   .colSeguranca .col-6{
    ...
    .trintaDias{
        ...
        .product_form{
            .col-sm-8{
                background-image:url('../../assets/img/3potesf.jpg');
